...
public class Rules {
	...
	public static VBox getRules()
	{
		...
		textRules1.setText("Chaque joueur à son tour place une bille de sa réserve sur une case de son choix.\n"
				...
				+"	- placer une bille de sa réserve sur le plateau.\n"
		...
		VBox rules = new VBox();
		rules.getChildren().addAll(getTitrePrincipal(), getTitre1(), textRules1, getTitre2(), textRules2, getTitre3(), textRules3);
